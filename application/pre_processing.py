"""
This module will clean a text corpus.
User can decide what all needs to be performed ion data pre-processing
"""
...
class TextCleaning:
    ...
    def strip_html_tags(self):
        """
        strip html tags for html document
        :return:
        """
    ...
    def normalize_corpus(self, doc, html_stripping=False, accented_char_removal=True,
                         text_lower_case=True, special_char_removal=True, stopword_removal=True,
                         remove_digits=True, text_lemmatization=False, text_stemming=False,):
        """
        ...
        if html_stripping:
            self.text = self.strip_html_tags()
